            ...
            <form method="POST" id="full-email-settings" class="full-widget-form" style="margin-bottom: 30px">
              ...
              <table>
                <tbody>
                  <tr>
                    ...
                    <td>
                      <label class="toggle-switch toggle-switch-sm" for="enableGlobalButton">
                        <input type="checkbox" name="enableGlobalButton" value="1" class="toggle-switch-input" id="enableGlobalButton" <?php checked($worker->get('enableGlobalButton')) ?>>
                  ...
                  <tr class="whatsapp <?= $worker->get('enableGlobalButton') ? '' : 'hidden' ?>">
                    <th>
                      <label for="whatsappNumber">Número de telefone</label>
                    </th>
                    <td>
                      <input type="text" inputmode="numeric" name="whatsappNumber" id="whatsappNumber" value="<?= $worker->get('enableGlobalButton') ? $worker->get('whatsappNumber') : '' ?>" class="custom-input">
                    </td>
                  </tr>
                  ...
                  <tr class="whatsapp <?= $worker->get('enableGlobalButton') ? '' : 'hidden' ?>">
                    ...
                    <td>
                      <input type="text" name="whatsappMessage" id="whatsappMessage" value="<?= $worker->get('enableGlobalButton') ? $worker->get('whatsappMessage') : '' ?>" class="custom-input">
                    </td>
                  </tr>
                  ...
                  <tr class="whatsapp <?= $worker->get('enableGlobalButton') ? '' : 'hidden' ?>">
                    ...
                    <td>
                      <input type="number" step="1" min="0" name="whatsappLogoSize" id="whatsappLogoSize" value="<?= $worker->get('enableGlobalButton') ? $worker->get('whatsappLogoSize') : '' ?>" class="custom-input">
                    </td>
                  </tr>

                  <tr class="whatsapp <?= $worker->get('enableGlobalButton') ? '' : 'hidden' ?>">
                    <th>
                      <label for="whatsappPosition">Local de exibição</label>
                    </th>
                    <td>
